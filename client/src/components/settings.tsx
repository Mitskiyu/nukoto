...
function Settings() {
	...
	return (
		<div className="w-full font-koden text-text h-[360px] flex flex-col bg-surface0 outline-1 outline-surface1 rounded-sm">
			<h1 className="text-2xl mb-4 ml-3.5 mt-3 text-lavender">Settings</h1>
			<div className="w-full flex flex-col -mt-2">
				<div className="flex justify-between items-center w-11/12 mx-auto">
					<label className="text-xl">Quality</label>
					<span className="text-lg text-mauve">80</span>
				</div>
